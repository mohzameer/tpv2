...
-- Projects table with 8-char alphanumeric id
...
-- Documents table with auto-increment integer id
...
CREATE TABLE document_contents (
  ...
  layout_mode TEXT DEFAULT 'both' CHECK (layout_mode IN ('notes', 'drawing', 'both')),
  layout_ratio REAL DEFAULT 50,
  text_mode TEXT DEFAULT 'text' CHECK (text_mode IN ('text', 'markdown')),
  updated_at TIMESTAMPTZ DEFAULT NOW()
);
